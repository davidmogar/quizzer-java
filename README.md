...
[![Build Status](https://travis-ci.org/davidmogar/quizzer-java.svg?branch=master)](https://travis-ci.org/davidmogar/quizzer-java)
...
###Dependencies
Quizzer requires JRE 8.0 or higher to run.
